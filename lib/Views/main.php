...
<html lang="en">
  ...
  <head>
    ...
    <title>Brice Bentler - Software Engineer & AWS Ninja</title>
  ...
  <body id="page-top">
    ...
    <nav class="navbar navbar-expand-lg bg-secondary fixed-top text-uppercase" id="mainNav">
      <div class="container">
        <a class="navbar-brand js-scroll-trigger" href="#page-top">Brice Bentler</a>
    ...
    <header class="masthead bg-primary text-white text-center">
      <div class="container">
        ...
        <h1 class="text-uppercase mb-0">Brice Bentler</h1>
        <hr class="star-light">
        <h2 class="font-weight-light mb-0">Software Engineer - DevOps - Site Reliability</h2>
      </div>
    </header>
      ...
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-lg-4 mr-auto">
            <p class="lead">I enjoy using tooling like Jenkins, Vagrant, and Rundeck. Configuration management with Ansible and Puppet is also neat. I also know a lot about Object Oriented Programming. If you would like to learn more about me:</p>
          </div>
        </div>
